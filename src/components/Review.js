            ...
            <div className='RevDiv'>
                <div className='Revitem'>
                    <div className='RevitemTitle'>
                        <p className='icon'><img src={process.env.PUBLIC_URL + '/icon.png'}  alt='icon_img'/><span>애견미용동영상</span>
                ...
                <div className='Revitem'>
                    <div className='RevitemTitle'><p className='icon'><img src={process.env.PUBLIC_URL + '/icon.png'}  alt='icon_img'/><span>애견미용후기</span>
